...
const TechnologyRelatedQuestions = () => (
    <Container>
        <Question>
            ...
            <div tw="flex flex-col gap-3">
                ...
                <Radio
                    ...
                    text="Javascript"
                />
                <Radio id="kotlin_language" name="language" value="kotlin" text="Kotlin" />
        ...
        <Question>
            <Typography>GDSC 스터디 참여 희망 분야(없다면 기타를 선택해 주세요)</Typography>
            <div tw="flex flex-col gap-3">
                <Radio
                    id="android"
                    name="study"
                ...
                <Radio id="go" name="study" value="go" text="Go - Backend(다른 언어 경험 필수)" />
                <Radio
                    id="computer_science"
                    name="study"
        ...
        <Question>
            <Typography>
                가장 관심 있는 기술 분야와 이유는 무엇인가요? 그리고 이 기술에 대한 어떤 경험을
                하셨나요?
            </Typography>
            <Input />
        </Question>
        <Question>
            <Typography>
                프로젝트를 진행해 보신 적이 있다면 어떠한 갈등 상황 혹은 문제점이 발생했고 이를
                어떻게 해결하셨나요?
            </Typography>
            <Input />
        </Question>
